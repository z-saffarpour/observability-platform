...
[فهرست داشبوردها](../README.md) · [راهنمای Grafana](../../../../../grafana/README.md) · [English](../../en/sql-exporter/sqlx-00-overview-ops.md) · [مستندات فارسی Exporter](../../../../sql-exporter/fa/grafana.md)
...
| فایل منبع | [`sqlx-00-overview-ops.json`](../../../../../grafana/dashboards/sql-exporter/sqlx-00-overview-ops.json) |
| برچسب‌ها | `sql_exporter`, `mssql`, `overview`, `ops`, `live` |
| تعداد پنل‌ها | 67 |
| بازهٔ تازه‌سازی | `15s` |
| نسخهٔ schema | `39` |
...
ترکیب نوع پنل‌ها: `row`: 6, `stat`: 28, `table`: 27, `timeseries`: 6
