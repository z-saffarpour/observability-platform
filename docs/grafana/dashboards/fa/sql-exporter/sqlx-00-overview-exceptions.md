...
[فهرست داشبوردها](../README.md) · [راهنمای Grafana](../../../../../grafana/README.md) · [English](../../en/sql-exporter/sqlx-00-overview-exceptions.md) · [مستندات فارسی Exporter](../../../../sql-exporter/fa/grafana.md)
...
| فایل منبع | [`sqlx-00-overview-exceptions.json`](../../../../../grafana/dashboards/sql-exporter/sqlx-00-overview-exceptions.json) |
| برچسب‌ها | `sql_exporter`, `mssql`, `overview`, `exceptions` |
| تعداد پنل‌ها | 98 |
| بازهٔ تازه‌سازی | `5m` |
| نسخهٔ schema | `39` |
