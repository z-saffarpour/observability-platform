...
[فهرست داشبوردها](../../README.md) · [راهنمای Grafana](../../../../../../grafana/README.md) · [English](../../../en/sql-exporter/Collector/sqlx-tempdb.md) · [مستندات فارسی Exporter](../../../../../sql-exporter/fa/grafana.md)
...
|---|---|
| UID | `sqlx-tempdb` |
| فایل منبع | [`sqlx-tempdb.json`](../../../../../../grafana/dashboards/sql-exporter/Collector/sqlx-tempdb.json) |
| برچسب‌ها | `sql_exporter`, `mssql`, `collector`, `tempdb` |
| تعداد پنل‌ها | 40 |
| بازهٔ تازه‌سازی | `1m` |
| نسخهٔ schema | `39` |
...
ترکیب نوع پنل‌ها: `bargauge`: 8, `row`: 7, `stat`: 8, `table`: 4, `timeseries`: 13
