...
[فهرست داشبوردها](../../README.md) · [راهنمای Grafana](../../../../../../grafana/README.md) · [English](../../../en/sql-exporter/Collector/sqlx-security.md) · [مستندات فارسی Exporter](../../../../../sql-exporter/fa/grafana.md)
...
|---|---|
| UID | `sqlx-security` |
| فایل منبع | [`sqlx-security.json`](../../../../../../grafana/dashboards/sql-exporter/Collector/sqlx-security.json) |
| برچسب‌ها | `sql_exporter`, `mssql`, `collector`, `security` |
| تعداد پنل‌ها | 63 |
| بازهٔ تازه‌سازی | `5m` |
| نسخهٔ schema | `39` |
...
ترکیب نوع پنل‌ها: `bargauge`: 7, `row`: 10, `stat`: 16, `table`: 23, `timeseries`: 7
