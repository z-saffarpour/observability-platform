...
[فهرست داشبوردها](../../README.md) · [راهنمای Grafana](../../../../../../grafana/README.md) · [English](../../../en/sql-exporter/Collector/sqlx-standard.md) · [مستندات فارسی Exporter](../../../../../sql-exporter/fa/grafana.md)
...
|---|---|
| UID | `sqlx-standard` |
| فایل منبع | [`sqlx-standard.json`](../../../../../../grafana/dashboards/sql-exporter/Collector/sqlx-standard.json) |
| برچسب‌ها | `sql_exporter`, `mssql`, `collector`, `standard` |
| تعداد پنل‌ها | 51 |
| بازهٔ تازه‌سازی | `30s` |
| نسخهٔ schema | `39` |
...
ترکیب نوع پنل‌ها: `bargauge`: 1, `row`: 8, `stat`: 8, `table`: 10, `timeseries`: 24
