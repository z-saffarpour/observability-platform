...
[فهرست داشبوردها](../../README.md) · [راهنمای Grafana](../../../../../../grafana/README.md) · [English](../../../en/sql-exporter/Collector/sqlx-service-broker.md) · [مستندات فارسی Exporter](../../../../../sql-exporter/fa/grafana.md)
...
| فایل منبع | [`sqlx-service-broker.json`](../../../../../../grafana/dashboards/sql-exporter/Collector/sqlx-service-broker.json) |
| برچسب‌ها | `sql_exporter`, `mssql`, `collector`, `service-broker` |
| تعداد پنل‌ها | 60 |
| بازهٔ تازه‌سازی | `1m` |
| نسخهٔ schema | `39` |
...
ترکیب نوع پنل‌ها: `bargauge`: 6, `row`: 9, `stat`: 20, `table`: 8, `timeseries`: 17
