...
[فهرست داشبوردها](../../README.md) · [راهنمای Grafana](../../../../../../grafana/README.md) · [English](../../../en/sql-exporter/Collector/sqlx-jobs-hub.md) · [مستندات فارسی Exporter](../../../../../sql-exporter/fa/grafana.md)
...
|---|---|
| UID | `sqlx-jobs-hub` |
| فایل منبع | [`sqlx-jobs-hub.json`](../../../../../../grafana/dashboards/sql-exporter/Collector/sqlx-jobs-hub.json) |
| برچسب‌ها | `sql_exporter`, `mssql`, `collector`, `jobs`, `hub` |
| تعداد پنل‌ها | 120 |
| بازهٔ تازه‌سازی | `1m` |
| نسخهٔ schema | `39` |
...
ترکیب نوع پنل‌ها: `bargauge`: 22, `row`: 25, `stat`: 40, `table`: 20, `timeseries`: 13
