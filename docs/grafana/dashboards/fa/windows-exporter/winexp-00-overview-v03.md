...
[فهرست داشبوردها](../README.md) · [راهنمای Grafana](../../../../../grafana/README.md) · [English](../../en/windows-exporter/winexp-00-overview-v03.md) · [مستندات فارسی Exporter](../../../../windows-exporter/fa/README.md)
...
| فایل منبع | [`winexp-00-overview-v03.json`](../../../../../grafana/dashboards/windows-exporter/winexp-00-overview-v03.json) |
| برچسب‌ها | `windows_exporter`, `overview`, `operations`, `v03` |
| تعداد پنل‌ها | 51 |
| بازهٔ تازه‌سازی | `5m` |
| نسخهٔ schema | `39` |
