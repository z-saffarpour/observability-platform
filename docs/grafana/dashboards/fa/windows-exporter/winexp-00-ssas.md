...
[فهرست داشبوردها](../README.md) · [راهنمای Grafana](../../../../../grafana/README.md) · [English](../../en/windows-exporter/winexp-00-ssas.md) · [مستندات فارسی Exporter](../../../../windows-exporter/fa/README.md)
...
|---|---|
| UID | `winexp-00-ssas` |
| فایل منبع | [`winexp-00-ssas.json`](../../../../../grafana/dashboards/windows-exporter/winexp-00-ssas.json) |
| برچسب‌ها | `windows_exporter`, `ssas`, `tabular`, `multidimensional`, `analysis-services` |
| تعداد پنل‌ها | 32 |
| بازهٔ تازه‌سازی | `1m` |
| نسخهٔ schema | `39` |
...
ترکیب نوع پنل‌ها: `bargauge`: 3, `stat`: 9, `table`: 4, `timeseries`: 16
