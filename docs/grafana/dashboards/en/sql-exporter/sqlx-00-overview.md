...
[Dashboard index](../README.md) · [Grafana guide](../../../../../grafana/README.md) · [فارسی](../../fa/sql-exporter/sqlx-00-overview.md) · [Exporter documentation](../../../../sql-exporter/en/grafana.md)
...
| Source file | [`sqlx-00-overview.json`](../../../../../grafana/dashboards/sql-exporter/sqlx-00-overview.json) |
| Tags | `sql_exporter`, `mssql`, `overview`, `canonical` |
| Panel count | 98 |
| Refresh interval | `1m` |
| Schema version | `39` |
