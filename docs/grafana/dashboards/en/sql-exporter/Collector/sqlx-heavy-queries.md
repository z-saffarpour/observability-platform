...
[Dashboard index](../../README.md) · [Grafana guide](../../../../../../grafana/README.md) · [فارسی](../../../fa/sql-exporter/Collector/sqlx-heavy-queries.md) · [Exporter documentation](../../../../../sql-exporter/en/grafana.md)

> This file is generated from the dashboard JSON; do not edit it manually.

Heavy-query operations view: live sessions come from `mssql_heavy_queries` (60s), while historical CPU/duration/grant rankings come from `mssql_plan_cache_hotspots` (5m).
...
| Source file | [`sqlx-heavy-queries.json`](../../../../../../grafana/dashboards/sql-exporter/Collector/sqlx-heavy-queries.json) |
| Tags | `sql_exporter`, `mssql`, `collector`, `queries`, `heavy_queries` |
| Panel count | 42 |
| Refresh interval | `1m` |
| Schema version | `39` |
...
Panel type summary: `bargauge`: 3, `row`: 11, `stat`: 12, `table`: 12, `timeseries`: 4
