...
[Dashboard index](../README.md) · [Grafana guide](../../../../../grafana/README.md) · [فارسی](../../fa/sql-exporter/sqlx-security-noc.md) · [Exporter documentation](../../../../sql-exporter/en/grafana.md)
...
| Source file | [`sqlx-security-noc.json`](../../../../../grafana/dashboards/sql-exporter/sqlx-security-noc.json) |
| Tags | `sql_exporter`, `mssql`, `security`, `noc` |
| Panel count | 48 |
| Refresh interval | `1m` |
| Schema version | `39` |
...
Panel type summary: `bargauge`: 6, `row`: 7, `stat`: 16, `table`: 14, `timeseries`: 5
